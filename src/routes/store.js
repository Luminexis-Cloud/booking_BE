...
const createStoreValidation = [
  ...
  body("name")
    ...
    .withMessage(
      "Store name is required and must be between 1 and 100 characters"
    ),
  body("areaOfWork")
    .notEmpty()
    .isLength({ min: 1, max: 50 })
    .withMessage(
      "Area of work is required and must be between 1 and 50 characters"
    ),
  body("teamSize")
  ...
  body("signature")
    ...
    .withMessage(
      "Signature is required and must be between 1 and 200 characters"
    ),
];
...
router.get(
  "/users/:userId/companies/:companyId/stores",
  authenticateToken,
  getStoresValidation,
  handleValidationErrors,
...
router.get(
  "/users/:userId/companies/:companyId/stores/:storeId",
  authenticateToken,
  getStoreValidation,
  handleValidationErrors,
